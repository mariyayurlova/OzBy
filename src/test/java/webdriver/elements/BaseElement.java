...
public abstract class BaseElement extends BaseEntity {
	...
	public void clickAndWait(String path, String element) {
		waitForIsElementPresent();
		info(getLoc("loc.clicking"));
		...
		browser.getDriver().findElement(By.xpath(path)).click();
	}
	
	public List<WebElement> findElements(String path) {
		return browser.getDriver().findElements(By.xpath(path));
	...
	public void moveToElement(String path){
		...
		WebElement elem = browser.getDriver().findElement(By.xpath(path));
